...
explaining/
  ...
  scripts/<topic>/<n.m>-<subject-slug>/  (POSITION; one of the 50 — neutral subject id, title is NEVER in the path)
    ...
    phase{0,1,2,3,5,6,8,9}_*.py per-phase drivers (channel-wide; two-lane phase1/phase3 PIP decoration). Shorts are purpose-drafted (record `data/debates/adopted/shorts-social-2026-06-15.md` — the SPEC was reaped 2026-08-09, `retire.sh --restore`; `short/phase9_shorts.py` thin over `scripts/_shorts.py`; `/shorts/` = manual YouTube flow).
