...
mode added by `data/specs/data-charter-2026-05-17.md` § 5 for writing
...
via the `parquet` archive class (`data/specs/artifact-archive-s3-2026-05-29.md`).
...
`data/specs/data-conventions-2026-05-06.md` § 5.3 conditionally: the lock
...
`financial/` per `data/specs/financial-hub-migration-2026-05-29.md`).
...
slot in the qagents-wide `/status` hub. Pinned to
`@qagents/diagram-kit` v0.4.1 (cross-subproject contract:
`qagents/CLAUDE.md` § "Status hub"). Self-contained — no
...
analyzing.json` per `data/specs/data-conventions-2026-05-06.md` § 5.3
...
`data/specs/display-modes-2026-05-07.md`. The next natural extension
